...
plt.title('Fluxo Radiante por Profundidade - Água Pura + CDOM')
plt.xlabel('Profundidade (m)')
plt.ylabel('Fluxo Radiante (W)')
...
plt.title('Fluxo Radiante por Altitude - Aerossóis Marinhos')
...
plt.title('Fluxo Radiante por Altitude - (Aerossóis Marinhos) (Água Pura + CDOM)')
plt.xlabel('Altitude (m)')
plt.ylabel('Fluxo Radiante (W)')
